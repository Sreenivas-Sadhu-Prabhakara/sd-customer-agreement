package com.bank.bian.customeragreement.model;
...
/**
 * The BIAN control record for this service domain: "Customer Agreement Management Plan".
 *
 ...
 * to its asset type (Customer Agreement). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Customer Agreement Management Plan";
